...
We evaluated our lens for this use-case, by a user study. Eight specialists in airport security (ages 23 to 43, experience in baggage scanning 8 months to 20 years, average familiarity with 3D tools, see Fig.~\ref{fig:questanswers}) were recruited. They all attended a 20-minute global demo of the lens technique operation, after which they were asked to examine the above-mentioned CT dataset to form a decision on the nature of the ninja star. They got 20 minutes of tool usage. At the end, they separatel) filled in a web questionnaire covering several questions and also provided open feedback (questionnaire available in supplementary material). Figure.~\ref{fig:questanswers} shows the answers. The first question (Q1) regarded how easy-to-use, generally effective, and effective \emph{vs} other known tools our lens is for \emph{random} inspection of the dataset. Here and next, other tools denote classical 2D X-ray scans or 3D CT scans used routinely in baggage scanning (see above). As Fig.~\ref{fig:questanswers}c-e shows, the answers were predominantly positive (neasured on a 5-point Likert scale, 1=very poor and 5=very good). The secon question (Q2) regarded how good our tool is to eamine \emph{specific} targets. Here again, the answers were predominantly positive (Fig.~\ref{fig:questanswers}f-h). Overall, the main appreciated features of our tool are listed in Fig.~\ref{fig:questanswers}i.


\begin{figure}[htbp!]
\centering
\includegraphics [width=0.4\textwidth]{images/questanswers.eps}
\vspace{-0.15cm}
